...
h36m_root = "/media/hkuit155/Windows/1TB_dataset/learnable_triangle_dataset/processed"
labels_path = "/media/hkuit155/Windows/1TB_dataset/learnable_triangle_dataset/extra/human36m-multiview-labels-GTbboxes.npy"

sample_idx = 0
step = 1

sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../../.."))
from reproject_utils.human36m import Human36MMultiViewDataset
...
while True:
    ...
    from reproject_utils.project import project_3d_points_to_image_plane_without_distortion as project
