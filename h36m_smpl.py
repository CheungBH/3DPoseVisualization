...
from utils.simple_transform_3d_smpl import SimpleTransform3DSMPL
...
class H36mSMPL(data.Dataset):
    ...
    def __init__(self,
                 cfg,
                 ann_file,
                 root='/media/hkuit155/6e1ff86c-973a-4c7d-acc8-acd6f9fe7b45/Downloads/Human3.6M',
                 train=True,
                 skip_empty=True,
                 dpg=False,
                 lazy_import=False):
...
if __name__ == '__main__':
    cfg_file = "configs/256x192_adam_lr1e-3-res34_smpl_3d_base_2x_mix.yaml"
    cfg = update_config(cfg_file)
    annot_file = cfg.DATASET.SET_LIST[0].TRAIN_SET
    HM = H36mSMPL(cfg, annot_file)

    print(len(HM._labels))
    print(len(HM._items))
